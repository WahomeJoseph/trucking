...
const challenges = [
      "Oversized loads require specialized permits and routing",
      "Project sites are often in remote or restricted locations",
      "Material delivery must align with precise construction schedules",
      "Equipment downtime due to delayed delivery is extremely costly",
]
const solutions = [
      {title:"Heavy Haulage",desc:"Lowbed trailers and crane trucks for oversized construction equipment"},
      {title:"Materials Transport",desc:"Bulk cement, steel, aggregate, and building materials delivery"},
      {title:"Project Management",desc:"Dedicated logistics coordinator for large construction projects"},
      {title:"Permit Handling",desc:"Full route survey and permit acquisition for abnormal loads"},
]
const stats = [
      {val:"300+",label:"Projects Delivered"},
      {val:"50+",label:"Heavy Vehicles"},
      {val:"100%",label:"On-Site Delivery"},
    ...
    <div>
      <section className="relative h-96 w-full">
        <div className="absolute inset-0">
          <Image src="/hero-truck.jpg" alt="Construction" fill className="object-cover" priority />
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center px-4">
          <div className="flex items-center justify-center w-full my-6">
            ...
            <h1 className="mx-6 text-4xl md:text-5xl font-bold text-white text-center">Construction</h1>
            <div className="flex-grow h-px bg-gradient-to-r from-transparent via-accent to-transparent max-w-[150px]" />
          </div>
          <p className="text-xl md:text-2xl text-white opacity-90 text-center max-w-2xl">Heavy haulage and project logistics</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="relative">
              <Image src="/truck-fleet.jpg" alt="Construction logistics" width={800} height={500} className="w-full h-[400px] object-cover rounded-2xl shadow-2xl" />
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4">Ready to Optimize Your Construction Logistics?</h2>
          <p className="text-white/80 max-w-2xl mx-auto mb-8">Get a customized solution designed for the construction sector.</p>
