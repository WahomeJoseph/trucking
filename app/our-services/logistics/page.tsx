...
const features = [
      {name:"Route Optimization",desc:"AI-powered route planning to minimize transit times and fuel costs"},
      {name:"Inventory Management",desc:"Real-time inventory tracking and automated reorder management"},
      {name:"Performance Analytics",desc:"Detailed KPI dashboards and monthly performance reports"},
      {name:"Vendor Coordination",desc:"Centralized vendor management and relationship coordination"},
      {name:"Risk Management",desc:"Proactive risk identification and contingency planning"},
      {name:"Cost Reduction",desc:"Average 20% cost reduction through optimized logistics processes"},
]
const processSteps = [
      {num:"01",title:"Logistics Audit",desc:"Comprehensive assessment of your current supply chain processes"},
      {num:"02",title:"Strategy Design",desc:"Custom logistics strategy aligned with your business objectives"},
      {num:"03",title:"Implementation",desc:"Phased rollout with dedicated project management support"},
      {num:"04",title:"Continuous Optimization",desc:"Ongoing monitoring and improvement of all logistics operations"},
]
    ...
    <div>
      <section className="relative h-96 w-full">
        <div className="absolute inset-0">
          <Image src="/hero-truck.jpg" alt="Logistics Management" fill className="object-cover" priority />
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center px-4">
          <div className="flex items-center justify-center w-full my-6">
            ...
            <h1 className="mx-6 text-4xl md:text-5xl font-bold text-white text-center">Logistics Management</h1>
            <div className="flex-grow h-px bg-gradient-to-r from-transparent via-accent to-transparent max-w-[150px]" />
          </div>
          <p className="text-xl md:text-2xl text-white opacity-90 text-center max-w-2xl">End-to-end supply chain optimization for African markets</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">Our logistics management service provides comprehensive supply chain visibility and control. From route optimization to performance analytics, we help businesses streamline their operations and reduce costs across East and Central Africa.</p>
            ...
            <div className="relative">
              <Image src="/hero-truck.jpg" alt="Logistics Management" width={800} height={500} className="w-full h-[400px] object-cover rounded-2xl shadow-2xl" />
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-white/80 max-w-2xl mx-auto mb-8">Contact TruckCorp today for a customized logistics management solution tailored to your needs.</p>
